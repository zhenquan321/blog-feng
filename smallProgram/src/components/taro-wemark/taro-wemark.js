            ...
            <View class="wemark_wrapper">
                {
                    this.state.renderList.length > 0 && this.state.renderList.map((renderBlock) =>
                        <View className={ 'wemark_block_' + renderBlock.type} key={renderBlock.blockIndex}>
                        {
                            renderBlock.isArray &&
                            renderBlock.content.map((renderInline) => 
                                <block key={renderInline.inlineIndex}>
                                {
                                    ...
                                    <Text className={ 'wemark_inline_' + renderInline.type}>{renderInline.content}</Text>
                        ...
                        {
                            !renderBlock.isArray && renderBlock.type === 'code' &&  <View>{renderBlock.content}</View> 
                        }
                        {
                            !renderBlock.isArray && renderBlock.type === 'video' &&  <Video className="wemark_block_video" src={renderBlock.src} poster={renderBlock.poster} controls></Video>
                        }
                        </View>
                    )
                }
