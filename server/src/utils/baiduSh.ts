...
// 设置APPID/AK/SK
const APP_ID: string = '17750270';
const API_KEY: string = 'ZXjewcGeAwu1GElXYPNmmCem';
const SECRET_KEY: string = 'N5lMCUiYsgDGXPM6bzw1hBEGpUAHnuC1';

// 新建一个对象，建议只保存一个对象调用服务接口
const client: any = new AipContentCensorClient(APP_ID, API_KEY, SECRET_KEY);
